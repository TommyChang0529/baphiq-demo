...
const MockData = {
  ...
  conversations: [
    ...
    },
    {
      ...
      messages: [
        ...
        { role: 'bot', text: '⚠️ 信心度不足，正在為您轉接真人客服...\n\n我無法確定是否有例外規定，讓專人為您說明。', sources: [] },
        { role: 'agent', text: '您好，我是客服人員小陳。關於緊急入境的特殊案例，目前法規並無例外條款，但您可以先入境並將犬隻送至指定隔離場所進行隔離檢疫。隔離期間需完成補打疫苗與抗體檢測。費用由飼主負擔。' },
      ]
    },
    {
      id: 'C-20260320-003',
  ...
  agentQueue: [
    {
      ...
      user: '使用者 A',
      waitTime: '2:35',
      summary: '抗體力價不足，詢問是否有例外',
      language: '英文',
      confidence: 0.45,
      previousMessages: [
        { role: 'bot', text: 'Hello! Welcome to the Pet Import/Export Quarantine Service.' },
        { role: 'user', text: 'My dog\'s rabies titer test result is 0.3 IU/ml, can I still bring it to Taiwan?' },
        { role: 'bot', text: 'The rabies neutralizing antibody titer must be ≥ 0.5 IU/ml. A result of 0.3 IU/ml does not meet the requirement.' },
        { role: 'user', text: 'But I already booked my flight for next week, is there any exception?' },
        { role: 'bot', text: '⚠️ 信心度不足，正在為您轉接真人客服...' },
      ]
    },
    {
      ...
      user: '使用者 B',
      waitTime: '0:45',
      summary: '從泰國帶貓入境，文件不齊全',
      language: '中文',
      confidence: 0.38,
      previousMessages: [
        { role: 'bot', text: '您好！歡迎使用犬貓出入境檢疫智慧客服系統。' },
        { role: 'user', text: '我在泰國救了一隻流浪貓想帶回台灣，但牠沒有打過疫苗也沒有晶片' },
        { role: 'bot', text: '⚠️ 信心度不足，正在為您轉接真人客服...' },
      ]
    },
  ],
  ...
  aiSettings: {
    temperature: 0.3,
    maxTokens: 2048,
    systemPrompt: '你是農業部動植物防疫檢疫署的犬貓出入境檢疫智慧客服。請依據知識庫內容回答問題，並附上相關法規來源。如果不確定答案，請誠實告知並建議轉接真人客服。',
  ...
  auditLogs: [
    ...
    { id: 'L006', time: '2026-03-20 10:12:33', user: '林小傑', action: '接聽轉接對話', target: 'C-20260320-002', ip: '10.0.1.61' },
